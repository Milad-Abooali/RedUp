...
$EX_user_id = ($_GET['i']) ?  $_GET['i']/379 : '0';
...
###########################
	...
	switch ($mmhclass->input->post_vars['upload_type']) {
		...
		case "url-standard":
			...
			// END WATERMARK MOD
								...
								$mmhclass->db->query("INSERT INTO `[1]` (`filename`, `total_rating`, `total_votes`, `voted_by`, `gallery_id`, `is_private`) VALUES ('[2]', '0', '0', '', '[3]', '[4]');", array(MYSQL_FILE_RATINGS_TABLE, $filename, $EX_user_id, $mmhclass->input->post_vars['private_upload']));

								$mmhclass->db->query("INSERT INTO `[1]` (`filename`, `is_private`, `gallery_id`, `file_title`, `album_id`,`dir_name`) VALUES ('[2]', '[3]', '[4]', '[5]', '[6]', '[7]'); ", array(MYSQL_FILE_STORAGE_TABLE, $filename, $mmhclass->input->post_vars['private_upload'], $EX_user_id, $filetitle, $mmhclass->input->post_vars['upload_to'], $rnd_dir_name));																																							

								$mmhclass->db->query("INSERT INTO `[1]` (`filename`, `filesize`, `ip_address`, `user_agent`, `time_uploaded`, `gallery_id`, `is_private`, `original_filename`, `upload_type`, `bandwidth`, `image_views`) VALUES ('[2]', '[3]', '[4]', '[5]', '[6]', '[7]', '[8]', '[9]', 'url', '[3]', '1'); ", array(MYSQL_FILE_LOGS_TABLE, $filename, $filesize, $mmhclass->input->server_vars['remote_addr'], $mmhclass->input->server_vars['http_user_agent'], time(), $EX_user_id, $mmhclass->input->post_vars['private_upload'], strip_tags($origname)));
		...
		case "normal-boxed":
			...
			// END WATERMARK MOD								
								...
								$mmhclass->db->query("INSERT INTO `[1]` (`filename`, `filesize`, `ip_address`, `user_agent`, `time_uploaded`, `gallery_id`, `is_private`, `original_filename`, `upload_type`, `bandwidth`, `image_views`) VALUES ('[2]', '[3]', '[4]', '[5]', '[6]', '[7]', '[8]', '[9]', 'normal', '[3]', '1'); ", array(MYSQL_FILE_LOGS_TABLE, $filename, $mmhclass->input->file_vars['userfile']['size'][$i], $mmhclass->input->server_vars['remote_addr'], $mmhclass->input->server_vars['http_user_agent'], time(), $EX_user_id, $mmhclass->input->post_vars['private_upload'], strip_tags($origname)));
	...
	case "zip-boxed":
		...
		foreach ($grab_files as $file) {
			...
			// END WATERMARK MOD								
					...
					$mmhclass->db->query("INSERT INTO `[1]` (`filename`, `filesize`, `ip_address`, `user_agent`, `time_uploaded`, `gallery_id`, `is_private`, `original_filename`, `upload_type`, `bandwidth`, `image_views`) VALUES ('[2]', '[3]', '[4]', '[5]', '[6]', '[7]', '[8]', '[9]', 'normal', '[3]', '1'); ", array(MYSQL_FILE_LOGS_TABLE, $filename, $filesize, $mmhclass->input->server_vars['remote_addr'], $mmhclass->input->server_vars['http_user_agent'], time(), $EX_user_id, $mmhclass->input->post_vars['private_upload'], strip_tags($origname)));
	...
	case "ulfy_boxed":
		...
		$sql = $mmhclass->db->query("SELECT * FROM `[1]` WHERE `session_key` = '[2]';", array(MYSQL_ULFY_TABLE,$mmhclass->input->post_vars['session']));
			...
			// END WATERMARK MOD								
								...
								$mmhclass->db->query("INSERT INTO `[1]` (`filename`, `filesize`, `ip_address`, `user_agent`, `time_uploaded`, `gallery_id`, `is_private`, `original_filename`, `upload_type`, `bandwidth`, `image_views`) VALUES ('[2]', '[3]', '[4]', '[5]', '[6]', '[7]', '[8]', '[9]', 'normal', '[3]', '1'); ", array(MYSQL_FILE_LOGS_TABLE, $filename, $row['size'], $mmhclass->input->server_vars['remote_addr'], $mmhclass->input->server_vars['http_user_agent'], time(), $EX_user_id, $mmhclass->input->post_vars['private_upload'], strip_tags($origname)));
   ...
   // END SHORT_URL MOD
            ...
            $ex_filename = current(explode(".", $filename));
            $ex_THUMBNAIL = 'http://redup.ir/images/'.$rnd_dir_name.$ex_filename.'_thumb.png';
            
			echo '
        <div id="image">
            <img  src="'.$ex_THUMBNAIL.'" /><hr />
            <a target="_blank" href="http://redup.ir/viewer/'.$filename.'">نمایش اطلاعات</a>
        </div>
<div id="bbcode" value="[URL=http://redup.ir/viewer/'.$filename.'][IMG]'.$ex_THUMBNAIL.'[/IMG][/URL]">[URL=http://redup.ir/viewer/'.$filename.'][IMG]'.$ex_THUMBNAIL.'[/IMG][/URL]</div>
			';
