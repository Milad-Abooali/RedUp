...
lang['001'] = "جهت انتخاب عنوان فایل کلیک کنید"; // File title if no title is set
lang['002'] = "حذف فایل"; // Notice to be used to remove a image upload field
lang['003'] = "سقف ارسال فایل 15 عدد به صورت همزمان است"; // Error to be displayed if too many new image upload fields are added
lang['004'] = "URL:"; // Notice to be used to indicate a image upload field is for an URL
lang['005'] = "حداقل یک فایل انتخاب کنید"; // Error to be displayed if no images are selected to delete or move on button press
lang['006'] = "بررسی مجدد"; // Notice to be used when to recheck username availablity 
lang['007'] = "نام کاربری مجاز نیست"; // Notice to be used when an username is not available
lang['008'] = "مجاز به انتخاب این نام هستید"; // Notice to be used when an username is available
