...
*/
	...
	$mmhclass->lang['6697'] = "<i>نصب نیست</i>";
	$mmhclass->lang['3384'] = " ";
	$mmhclass->lang['3484'] = "<a href=\"%s\"><i class='fa fa-fw fa-arrow-left'></i></a>";
	$mmhclass->lang['5475'] = "<a href=\"%s\"><i class='fa fa-fw fa-arrow-right'></i></a>";
	$mmhclass->lang['7033'] = "
    <div class='col-sm-3 pull-right text-right'>
        صفحه <b>%s</b> از <b>%s</b>
	</div>
	<div class='col-sm-9 pull-left cb-ltr text-left'>
	  %s
    </div>";
	  
	$mmhclass->lang['5834'] = "<div class=\"pagination\">%s</div>";
	$mmhclass->lang['4552'] = "خطا در ایجاد لینک تصویر";
