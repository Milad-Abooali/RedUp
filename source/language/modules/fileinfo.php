...
<br />
<a href=\"javascript:void(0);\" onclick=\"$('div[class=lightbox_main]').parent().remove();\">بستن پنجره</a>";
	$mmhclass->lang['002'] = "تصویر با نام <b>%s</b> یافت نشد.<br />
مطمئن شوید نام فایل صحیح است.<br />
<br />
<a href=\"javascript:void(0);\" onclick=\"$('div[class=lightbox_main]').parent().remove();\">بستن پنجره</a>";
