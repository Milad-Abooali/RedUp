<!-- BEGIN: ACP STYLE #35759 -->
<template id="system_upgrade_page">

<script type="text/javascript">
	function begin_upgrade()
	{
		$("div[id=upgrade_info]").toggle();
		o$("input[id=upgrade_button]").attr("disabled", "disabled");
		
		/*var download_data = get_ajax_content("be.php?act=upgrade-df");
		
		switch (download_data) {
			case "001":
				alert("Upgrade is not needed. Running latest version already.");
				break;
			case "002":
				alert("Failed to retrieve list of changed files. Upgrade failed.");
				break;
			case "003":
				alert("Failed to write upgrade packages to disk. Upgrade failed.");
				break;
			case "004":
				location.href = "be.php?act=upgrade-d";
				break;
		}
		
		$("div[id=upgrade_info]").toggle();
		$("input[id=upgrade_button]").removeAttr("disabled");*/
	}
</script>

<div class="text_align_center" id="upgrade_info" style="display: none;">
    Please stand by while latest version is downloaded and unpacked...
    <br /><br />
    
    <img src="css/images/progress_bar.gif" alt="Loading..." />
    <br /><br />
    
    <em>Do <strong style="color: #F00;">NOT</strong> close browser or refresh page during this download.</em><br />
    <em>The upgrade process can take up to a minute depending on size of upgrade.</em>
    <br /><hr />
</div>
...
<div class="table_border">
    <table cellpadding="4" cellspacing="1" border="0" style="width: 100%;">
        <tr>
            <th>Upgrade Information</th>
        </tr>
        <tr>
        	<td class="tdrow1">
            	Please confirm the following information before continuing upgrade.
                <br /><br />
                
                <strong>Upgrading To:</strong> Mihalism Multi Host v<# NEW_VERSION #><br />
                <strong>Upgrading From:</strong> Mihalism Multi Host v<# OLD_VERSION #>
               	<br /><br />
                
                <em>Once upgrade begins there is no undo.</em>
                <br /><br />
                 
                <strong>Important:</strong> Remember to <strong style="color: #F00;">backup</strong> all your files and databases before continuing with this upgrade. <br />
                <strong>Important:</strong> If <a href="http://us2.php.net/manual/en/ref.zip.php">PHP Zip Functions</a> are not available, then Mihalism Multi Host will only <a href="http://mihalism.net/multihost/download.php">download latest version</a>, not copy over.
			</td>
		</tr>
        <tr>
        	<td class="table_footer"><input type="button" onclick="begin_upgrade();" class="button1" id="upgrade_button" value="Begin Upgrade" /></td>
        </tr>
	</table>
</div><hr />
...
<div class="table_border">
    <table cellpadding="4" cellspacing="1" border="0" style="width: 100%;">
        ...
        <tr>
        	<td class="tdrow1"><br />
            	<em style="margin-left: 10px;"><strong>Note:</strong> Clicking on a filename listed below will compare the <a href="http://en.wikipedia.org/wiki/Subversion_(software)" target="_blank">SVN</a> version of it to the local copy. </em> 
                <br /><br />
              
                <ol>
                    <while id="changed_file_list">
                        <li><a href="be.php?act=filediff&amp;file=<# FILENAME #>" target="_blank"><# FILENAME #></a></li>
                    </endwhile>
                </ol><br />
			</td>
		</tr>
...
The following is general system information and debugging information for <a href="http://en.wikipedia.org/wiki/Power_user#Other_uses"><em>power</em></a> Mihalism Multi Host users.
<br /><br />
...
<table cellpadding="4" cellspacing="1" border="0" style="width: 100%;">
	...
	<tr>
		<td class="tdrow1 text_align_center">
			<br />
			<form action="be.php?act=albums-d-d" method="post">
				<p>
...
<table cellpadding="4" cellspacing="1" border="0" style="width: 100%;">
	...
	<tr>
		<td class="tdrow1 text_align_center">
			<br />
			<form action="be.php?act=albums-r-d" method="post">
				<p>
					<b>New Album Title</b>:
					<br /><br />
...
<table cellpadding="4" cellspacing="1" border="0" style="width: 100%;">
	...
	<tr>
		<td class="tdrow1 text_align_center">
			<br />
			<form action="be.php?act=albums-c-d" method="post">
				<p>
					<b>Album Title</b>:
					<br /><br />
...
<table cellpadding="4" cellspacing="1" border="0" style="width: 100%;">
	...
	<tr>
		<td class="tdrow1 text_align_center">
			<br />
			<form action="be.php?act=move_files-d" method="post">
				<p>
					<b>Move To</b>:
					<br /><br />
...
<div class="align_left_mfix">
    <ul class="jd_menu">
        ...
        <if="$mmhclass->info->user_owned_gallery == false">
            <li><a href="be.php?act=user_list" class="button1">User Galleries</a>
		...
		<li><span onclick="gallery_action('recreate');" title="Recreate Thumbs" class="button1">Recreate Thumbs</span></li>
            <li><span class="button1">Album List</span>
                <ul class="menu_border">
                    ...
                    <li class="item"><a href="javascript:void(0);" onclick="toggle_lightbox('be.php?act=albums-c&amp;id=<# GALLERY_ID #>', 'new_album_lightbox');">New Album</a></li>
                    ...
                    <while id="album_pulldown_whileloop">
                        <li class="item"> 
                            ...
                            ( <a href="javascript:void(0);" onclick="toggle_lightbox('be.php?act=albums-d&amp;album=<# ALBUM_ID #>&amp;id=<# GALLERY_ID #>', 'delete_album_lightbox');">Delete</a> |
                            <a href="javascript:void(0);" onclick="toggle_lightbox('be.php?act=albums-r&amp;album=<# ALBUM_ID #>&amp;id=<# GALLERY_ID #>', 'rename_album_lightbox');">Rename</a> )
                        </li>
                    </endwhile>
                </ul>
            </li>
...
<table cellpadding="4" cellspacing="1" border="0" style="width: 100%;">
	...
	<tr>
		<td class="tdrow1 text_align_center">
			<br />
			<form action="be.php?act=users-d-d" method="post">
				<p>
					Are you sure you wish to carry out this operation? 
					<br /><br />
					If you select "Yes" there is no undo.
...
<form action="be.php?act=users-s-s" method="post">
		...
		<table cellpadding="4" cellspacing="1" border="0" style="width: 100%;">
			...
			<tr>
				...
				<td class="tdrow2" valign="top">
                	...
                	<a href="be.php?act=mass_email&amp;id=<# USER_ID #>">Send E-Mail</a>
                </td>
			</tr>
			<tr>
	...
	<table cellpadding="4" cellspacing="1" border="0" style="width: 100%;">
		...
		<while id="user_list_whileloop">
			<tr>				
				...
				<td class="<# TDCLASS #>"><a href="be.php?gal=<# USER_ID #>"><# USERNAME #></a></td>
				<td class="<# TDCLASS #>"><a href="be.php?act=mass_email&amp;id=<# USER_ID #>"><# EMAIL_ADDRESS #></a></td>
				...
				<td class="<# TDCLASS #>"><a href="javascript:void(0);" onclick="toggle_lightbox('be.php?act=users-d&amp;id=<# USER_ID #>', 'delete_user_lightbox');">Delete</a> | <a href="be.php?act=users-s&amp;id=<# USER_ID #>">Settings</a></td>
			</tr>
		</endwhile>
...
<form action="be.php?act=mass_email-s" method="post">
	<div class="table_border">
		<table cellpadding="4" cellspacing="1" border="0" style="width: 100%;">
			<tr>
			...
			<tr>
				<td class="table_footer" colspan="2">
                	<input type="button" class="button1" value="Preview Message" onclick="if($('textarea[name=message_body]').val()==''){alert('No message to preview.');}else{toggle_lightbox(('be.php?act=mass_email-p&amp;post=' + base64_encode($('textarea[name=message_body]').val())), 'mass_email_preview_lightbox');}" />
...
<form action="be.php?act=ban_control-u" method="post">
	<div class="table_border">
		<table cellpadding="4" cellspacing="1" border="0" style="width: 100%;">
			<tr>
...
<table cellpadding="4" cellspacing="1" border="0" style="width: 100%;">
	...
	<tr>
		<td class="tdrow1 text_align_center">
			<br />
			<form action="be.php?act=delete_files-d" method="post">
				<p>
					Are you sure you wish to carry out this operation? 
					<br /><br />
					If you select "Yes" there is no undo.
    	...
    	<li><span class="button1">Search</span>
            <ul class="menu_border">
                ...
                <li class="item text_align_center">
                    ...
                    <input type="button" value="Go" id="file_search_button" onclick="location.href=('be.php?act=file_logs<# ORDERBY_URL_QUERY #>&amp;search=' + encodeURIComponent($('input[id=file_search]').val()));" />
                    <br /><br />
                    <b>%</b> and <b>_</b> are <a href="http://dev.mysql.com/doc/refman/5.0/en/string-comparison-functions.html#operator_like" target="_blank">wildcard characters</a>.
                </li>
            </ul>
    	...
    	<li><span class="button1">Order By</span>
            <ul class="menu_border">
                ...
                <li class="item text_align_center">
                    ...
                    <input type="button" value="Go" onclick="location.href=('be.php?act=file_logs<# FILENAME_SEARCH_QUERY #>&amp;orderby=' + encodeURIComponent($('select[id=orderby_field] option:selected').val()) + '&amp;sort=' + encodeURIComponent($('select[id=orderby_sort] option:selected').val()));" />
                </li>
            </ul>
    	</li>
        
        <li><a href="be.php?act=file_logs-el" class="button1" onclick="if(confirm('There is no undo. Continue?')==false){return false;}">Purge Logs</a></li>
    </ul>
</div>
	...
	<table cellpadding="4" cellspacing="1" border="0" style="width: 100%;">
		...
		<while id="language_file_whileloop">
			<tr>				
				...
				<td class="<# TDCLASS #>"><a href="be.php?act=language_settings-e&amp;file=<# FILE_ID #>"><# FILENAME #></a></td>
...
<script type="text/javascript">
	...
	{
		window.location = ("be.php?act=language_settings-rd&file_id=" + id);
	}
</script>

<form action="be.php?act=language_settings-e-s" method="post">
    <div class="align_left_mfix">
    ...
    <div class="align_right_mfix">
        <a href="be.php?act=language_settings" class="button1">Language Settings</a>
    </div>
    <br /><br />
...
<div class="align_left_mfix">
	<a href="be.php?act=robot_logs-de" onclick="if(confirm('There is no undo. Continue?')==false){return false;}" class="button1">Purge Logs</a>
</div>
...
<div class="align_left_mfix">
    <ul class="jd_menu">
        <li><a href="javascript:void(0);" onclick="$('tr[class=misc_settings]').toggle(); if($('tr[class=misc_settings]:visible').length > 1){scroll($(document).width(), $(document).height());}"><span class="button1">Miscellaneous Settings</span></a></li>
		<li><a href="javascript:void(0);" onclick="$('tr[class=report_problems]').toggle(); if($('tr[class=report_problems]:visible').length > 1){scroll($(document).width(), $(document).height());}"><span class="button1">Report Problems</span></a></li>
        <li><a href="javascript:void(0);" onclick="$('tr[class=donations]').toggle(); if($('tr[class=donations]:visible').length > 1){scroll($(document).width(), $(document).height());}"><span class="button1">Donations</span></a></li>
	</ul>
</div>
<br /><br />
<form action="be.php?act=site_settings-s" method="post">
	<div class="table_border">
		<table cellpadding="4" cellspacing="1" border="0" style="width: 100%;">
			<tr>
            ...
            <if="$mmhclass->templ->templ_globals['new_version'] == true">
                <tr>
                    <td colspan="2" class="new_version_box">
                        A new version of Mihalism Multi Host has become available.<br />
            ...
            <tr style="display: none;" class="report_problems">
				<td style="width: 38%;" class="tdrow1"><span>Report problems:</span> <br /> 
				...
				2. <a target="_blank" href="http://www.mihalismscript.com/">Mihalism Script</a></td>
			</tr>
			<tr style="display: none;" class="donations">
				<td style="width: 38%;" class="tdrow1"><span>Donations:</span> <br /> <div class="explain">
					All donations are welcome to help develop Mihalism Multi Host.</div></td> 
				<td class="tdrow2">
			...
			<tr>
				<td style="width: 38%;" class="tdrow1"><span>Max Filesize:</span> <br /> <div class="explain">The maximum allowed filesize per file for Guests. There are exactly 1048576 Bytes for every one Megabyte. <a href="http://www.t1shopper.com/tools/calculate/" target="_new">Conversion Calculator</a>.</div></td> 
			...
			<tr>
				<td style="width: 38%;" class="tdrow1"><span>Max Filesize (Users):</span> <br /> <div class="explain">The maximum allowed filesize per file for registered users. There are exactly 1048576 Bytes for every one Megabyte. <a href="http://www.t1shopper.com/tools/calculate/" target="_new">Conversion Calculator</a>.</div></td> 
			...
			<tr>
				<td style="width: 38%;" class="tdrow1"><span>Max simultaneous Uploads (Guests):</span> <br /> <div class="explain">The number of files Guest can upload at once using the upload widget</div></td>
				<td class="tdrow2" valign="top"><input type="text" class="input_field" style="width: 300px;" name="guest_simul_upload" value="<# GUEST_MAX_SIMUL_FILES #>" /> Files</td>
			</tr>
			<tr>
				<td style="width: 38%;" class="tdrow1"><span>Max simultaneous Uploads (Users):</span> <br /> <div class="explain">The number of files registered users can upload at once using the upload widget</div></td>
				<td class="tdrow2" valign="top"><input type="text" class="input_field" style="width: 300px;" name="user_simul_upload" value="<# USER_MAX_SIMUL_FILES #>" /> Files</td>
			</tr>
			<tr>
				<td style="width: 38%;" class="tdrow1"><span>Max Bandwidth:</span> <br /> <div class="explain">The maximum allowed <a href="http://en.wikipedia.org/wiki/Bandwidth_(computing)" target="_new">bandwidth use</a> per file for Guests. Bandwidth tracking requires that the setting "<a href="#proxyimages">Proxy Images</a>" be enabled.</div></td> 
				<td class="tdrow2" valign="top"><input type="text" class="input_field" style="width: 300px;" name="max_bandwidth" value="<# MAX_BANDWIDTH #>" /> Megabytes</td>
			</tr>
			 <tr>
            <td style="width: 38%;" class="tdrow1"><span>Show Hotlinks:</span> <br /> <div class="explain">Allowing Hotlinking can increase your traffic</div></td> 
            <td class="tdrow2" valign="top"><input type="radio" value="1" name="hotlink" <# HOTLINK_ALLOWED #> /> Yes <input type="radio" value="0" name="hotlink" <# HOTLINK_NOT_ALLOWED #> /> No</td>
			</tr>
			<tr>
            <td style="width: 38%;" class="tdrow1"><span>SEO Friendly URLs:</span> <br /> <div class="explain">If turned on, <a href="http://httpd.apache.org/docs/current/mod/mod_rewrite.html" target="_new">mod_rewrite</a> will be used to create more SEO friendly imageurls, like mydomain.com/testimage.jpg.html. On servers running <a href="http://httpd.apache.org/" target="_new">Apache</a>, <strong>mod_rewrite and the ".htaccess" files are required.</strong> If you are running <a href="http://www.lighttpd.net/" target="_new">Lighttpd</a> or <a href="http://nginx.org/" target="_new">nginx</a>, rewrite rules need to be applied to the config.</div></td> 
	    <td class="tdrow2" valign="top"><input type="radio" value="1" name="url_rewrite" <# USE_REWRITE #> /> Yes <input type="radio" value="0" name="url_rewrite" <# DONT_USE_REWRITE #> /> No</td>
			</tr>
			<tr>
				<td style="width: 38%;" class="tdrow1"><span>Max Bandwidth (Users):</span> <br /> <div class="explain">The maximum allowed <a href="http://en.wikipedia.org/wiki/Bandwidth_(computing)" target="_new">bandwidth use</a> per file for registered users. Bandwidth tracking requires that the setting "<a href="#proxyimages">Proxy Images</a>" be enabled.</div></td> 
				<td class="tdrow2" valign="top"><input type="text" class="input_field" style="width: 300px;" name="user_max_bandwidth" value="<# USER_MAX_BANDWIDTH #>" /> Megabytes</td>
			</tr>
			<tr>
			...
			<tr>
				<td style="width: 38%;" class="tdrow1"><span>Thumbnail Format:</span> <br /> <div class="explain">This setting can have a large effect on bandwidth usage. For a side-by-side size comparison click <a href="css/images/thumbnail_compare.jpg" class="top_up" toptions="effect = clip, shaded = 1, layout = flatlook">here</a>. Only thumbnails created after a change to this setting will be affected by the change.</div></td> 
				<td class="tdrow2" valign="top">
            ...
            <tr>
            	<td style="width: 38%;" class="tdrow1"><span>Proxy Images:</span> <br /> <div class="explain">Should Mihalism Multi Host <a href="http://en.wikipedia.org/wiki/Anonymous_proxy_server" target="_new">proxy</a> images through itself. By doing this, bandwidth usage of individual images can be tracked. Image views can also be counted. This system can increase server load on large hosts so think carefully before enabling. <a href="http://httpd.apache.org/docs/current/mod/mod_rewrite.html" target="_new">mod_rewrite</a> is required. If you are using <a href="http://www.lighttpd.net/" target="_new">Lighttpd</a> or <a href="http://nginx.org/" target="_new">nginx</a> rewrite rules must be applied to config!</div></td> 
           		<td class="tdrow2" valign="top"><input type="radio" value="1" name="proxy_images" <# PROXY_IMAGES_YES #> /> Yes <input type="radio" value="0" name="proxy_images" <# PROXY_IMAGES_NO #> /> No</td>
            </tr>
			...
			<tr>
				...
				<td class="tdrow2"><input type="radio" value="1" name="registration_disabled" <# REGISTRATION_DISABLED_YES #> /> Yes <input type="radio" value="0" name="registration_disabled" <# REGISTRATION_DISABLED_NO #> /> No</td>
			</tr>
			        <tr>
            <td style="width: 38%;" class="tdrow1"><span>URL Shortener:</span></td> 
            <td class="tdrow2" valign="top"><input type="radio" value="none" name="shortener" <# SHORTENER_NONE #> /> None <input type="radio" value="goo.gl" name="shortener" <# SHORTENER_GOO.GL #> /> goo.gl <input type="radio" value="bit.ly" name="shortener" <# SHORTENER_BIT.LY #> /> bit.ly <input type="radio" value="adf.ly" name="shortener" <# SHORTENER_ADF.LY #> /> adf.ly </td>
         </tr>
         <tr>
            <td style="width: 38%;" class="tdrow1"><span>URL Shortener API-Key:</span> <br /> <div class="explain">API-Key for goo.gl or bit.ly service.</div></td> 
            <td class="tdrow2" valign="top"><input type="text" style="width: 300px;" class="input_field" name="shortener-api-key" value="<# SHORTENER_API_KEY #>" /></td>
         </tr>
         <tr>
            <td style="width: 38%;" class="tdrow1"><span>bit.ly username / adf.ly uid:</span> <br /> <div class="explain">When using bit.ly you need to enter your bit.ly-username here. With adf.ly enter your uid as found on the "API Documentation" page</div></td> 
            <td class="tdrow2" valign="top"><input type="text" style="width: 300px;" class="input_field" name="shortener-bitly-login" value="<# SHORTENER_BITLY_LOGIN #>" /></td>
         </tr>
         <tr>
            <td style="width: 38%;" class="tdrow1"><span>Watermark Images:</span> <br /> <div class="explain">If you choose "YES" make shure your Watermark-Image is a PNG called watermark.png and is at /css/watermark/</div></td> 
            <td class="tdrow2" valign="top"><input type="radio" value="1" name="watermark" <# WATERMARK_YES #> /> Yes <input type="radio" value="0" name="watermark" <# WATERMARK_NO #> /> No</td>
         </tr>
         <tr>
            <td style="width: 38%;" class="tdrow1"><span>Watermark Position:</span></td> 
            <td class="tdrow2" valign="top">
	...
	<tr>
	<td style="width: 38%;" class="tdrow1"><span>Facebook Comments:</span><div class="explain">Enable comments below picture viewer through <a href="https://developers.facebook.com/docs/reference/plugins/comments/" target="_new">Facebook Social Plugin Comments</a></div></td> 
	<td class="tdrow2" valign="top"><input type="radio" value="1" name="facebook_comments" <# FB_COMM_YES #> /> Yes <input type="radio" value="0" name="facebook_comments" <# FB_COMM_NO #> /> No
	</td></tr>
            ...
            <tr style="display: none;" class="misc_settings">
                <td style="width: 38%;" class="tdrow1"><span>Google Analytics (optional):</span> <br /> <div class="explain">Profile ID for the <a href="http://www.google.com/analytics" target="_new">Google Analytics</a> tracking service.</div></td> 
            ...
            <tr style="display: none;" class="misc_settings">
                <td style="width: 38%;" class="tdrow1"><span>reCAPTCHA Public Key:</span> <br /> <div class="explain">Public API Key for the popular spam prevention service, <a href="http://recaptcha.net/" target="_new">reCAPTCHA</a>.</div></td> 
            ...
            <tr style="display: none;" class="misc_settings">
                <td style="width: 38%;" class="tdrow1"><span>reCAPTCHA Private Key:</span> <br /> <div class="explain">Private API Key for the popular spam prevention service, <a href="http://recaptcha.net/" target="_new">reCAPTCHA</a>.</div></td> 
