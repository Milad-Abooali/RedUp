...
<div class="back-to-top light text-center"><i class="fa fa-arrow-circle-o-up fa-2x"></i><br /> بالا</div>
   ...
   <div id="RedupHeader" class="container">   
      <div class="col-lg-12">
         <ul id="topnav">
            <li><a href="be.php">تنظیمات</a>
               <span>
					<a href="be.php?act=site_settings">Site Settings</a> |
					<a href="be.php?act=language_settings">Language Settings</a>
               </span>
            </li>
            <li><a href="users.php?act=user_list">کاربران</a>
               <span>
					<a href="be.php?act=ban_control">Ban Control</a> |
					<a href="be.php?act=user_list">User Management</a> |
					<a href="be.php?act=mass_email">Bulk E-Mail</a>
               </span>
            </li>
            <li><a href="#">گزارش ها</a>
               <span>
					<a href="be.php?act=file_logs">File Logs</a> |
					<a href="be.php?act=robot_logs">Search Engine Logs</a>
               </span>
            </li>
            <li><a href="gallery.php">Debuge Tools</a>
               <span>
					<a href="be.php?act=errlogs">PHP Error Logs</a> |
					<a href="be.php?act=phpinfo">PHP Information</a> |
					<a href="be.php?act=processes">Running Processes</a> |
					<a href="be.php?act=sysinfo">System Information</a>
               </span>
            </li>
