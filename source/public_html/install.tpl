...
<div class="table_border">
	<table cellpadding="4" cellspacing="1" border="0" style="width: 100%;">
		<tr><th colspan="2">Pre-Install Checks Results:</th></tr>
		<tr>
		...
		<tr>
			<td colspan="2" class="table_footer"><if="<# NUMBER_OF_ERRORS #> != 0"><b>Please correct the found errors and refresh this page!</b><else>
